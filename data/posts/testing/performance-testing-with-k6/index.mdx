...
description: Learn about how to use Grafana's K6 to do various Performance Testing
...
import oneTimeCode from './code-and-output/one-time.js?raw'
import oneTimeOutput from './code-and-output/one-time.txt?raw'

<CodeTabs
  codes={[
    { lang: 'js', title: 'first-script.js', code: oneTimeCode },
    { lang: 'sh', title: 'output', code: oneTimeOutput },
  ]}
/>
...
<CodeTabs
  codes={[
    { lang: 'js', title: 'iteration.js', code: iterationCode },
    { lang: 'sh', title: 'output', code: iterationOutput },
  ]}
/>
...
import nUsersCode from './code-and-output/n-users.js?raw'
import nUsersCodeOutput from './code-and-output/n-users.txt?raw'

<CodeTabs
  codes={[
    { lang: 'js', title: 'n-users.js', code: nUsersCode },
    { lang: 'sh', title: 'output', code: nUsersCodeOutput },
  ]}
/>

### Ramping Users

import rampUpUsersCode from './code-and-output/ramp-up-users.js?raw'
import rampUpUsersCodeOutput from './code-and-output/ramp-up-users.txt?raw'

<CodeTabs
  codes={[
    { lang: 'js', title: 'ramp-up-users.js', code: rampUpUsersCode },
    { lang: 'sh', title: 'output', code: rampUpUsersCodeOutput },
  ]}
/>
...
import constantRateLessVUsOutput from './code-and-output/constant-rate-less-vus.txt?raw'
import constantRateCode from './code-and-output/constant-rate.js?raw'
import constantRateOutput from './code-and-output/constant-rate.txt?raw'

<CodeTabs
  codes={[
    { lang: 'js', title: 'constant-rate.js', code: constantRateCode },
    { lang: 'sh', title: 'output', code: constantRateOutput },
    { lang: 'sh', title: 'output with less VUs', code: constantRateLessVUsOutput },
  ]}
/>
...
<CodeTabs
  codes={[
    { lang: 'js', title: 'ramping-rate.js', code: rampingRateCode },
    { lang: 'sh', title: 'output', code: rampingRateOutput },
  ]}
/>
...
import multipleScenariosCode from './code-and-output/multiple-scenario.js?raw'
import multipleScenariosOutput from './code-and-output/multiple-scenario.txt?raw'

<CodeTabs
  codes={[
    { lang: 'js', title: 'ramping-rate.js', code: multipleScenariosCode },
    { lang: 'sh', title: 'output', code: multipleScenariosOutput },
  ]}
/>
