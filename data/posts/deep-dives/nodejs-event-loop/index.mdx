...
import ReadMorePost from '@/modules/post/read-more-post.astro'
import ResponsiveImage from '@/components/responsive-image.astro'
import nextTickAndPromises from './nexttick-and-promises.jpg'
import nodejsEventLoopWithExample from './nodejs-event-loop-with-example.png'
import phasesOverview from './phases-overview.jpg'
...
<ResponsiveImage src={phasesOverview} alt='Phases by Bert Belder at Node Interactive - 2016'>
  Phases by Bert Belder at Node Interactive - 2016
</ResponsiveImage>
...
<ReadMorePost postId='deep-dives/nodejs-libuv' headingId='poll-timeout-is-calculated' />
...
<ResponsiveImage alt='NextTick & Promises Slide by Bert Belder at Node Interactive - 2016' src={nextTickAndPromises}>
  NextTick & Promises Slide by Bert Belder at Node Interactive - 2016
</ResponsiveImage>
