...
featuredRank: 3
image: ./libuv-architecture.webp
imageCredit: Libuv Design Overview from [libuv.org](https://docs.libuv.org/en/v1.x/design.html)
articleLink: null
category: deep-dives
tags:
  - js
...
import loopIteration from './loop_iteration.webp'
...
<ResponsiveImage src={asyncOperations} alt='Async Operations Slide by Bert Belder at Node Interactive - 2016'>
  Async Operations Slide by Bert Belder at Node Interactive - 2016
</ResponsiveImage>
...
<ResponsiveImage src={loopIteration} alt='Loop Iteration '>
  Loop Iteration from libuv.org
</ResponsiveImage>
